...
import (
	...
	dStub "github.com/NanoNets/migrate/database/stub"
	"github.com/NanoNets/migrate/source"
	sStub "github.com/NanoNets/migrate/source/stub"
)
...
func ExampleNewWithDatabaseInstance() {
	...
	// `import "github.com/NanoNets/migrate/database/postgres"`
...
func ExampleNewWithSourceInstance() {
	...
	// `import "github.com/NanoNets/migrate/source/stub"`
