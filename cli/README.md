...
```
$ go get -u -d github.com/NanoNets/migrate/cli github.com/lib/pq
$ go build -tags 'postgres' -o /usr/local/bin/migrate github.com/NanoNets/migrate/cli
```
...
([todo #156](https://github.com/NanoNets/migrate/issues/156))
...
[Release Downloads](https://github.com/NanoNets/migrate/releases)

```
$ curl -L https://github.com/NanoNets/migrate/releases/download/$version/migrate.$platform-amd64.tar.gz | tar xvz
```
